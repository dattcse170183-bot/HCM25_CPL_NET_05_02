...
namespace MovieTheater.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public PaymentController(VNPayService vnPayService, IAccountService accountService, ILogger<PaymentController> logger, MovieTheater.Models.MovieTheaterContext context, IFoodInvoiceService foodInvoiceService, IHubContext<DashboardHub> dashboardHubContext)
        {
